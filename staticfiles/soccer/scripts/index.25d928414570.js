...
function convertToLocalTime(dateString) {
    // Parse the string into a proper Date object, considering the format from Django
    let parsedDate = new Date(dateString);

    // Handle cases where the browser fails to parse the string directly
    if (isNaN(parsedDate.getTime())) {
        // Add "T" between date and time if not in ISO format
