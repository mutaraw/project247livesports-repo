...
function convertToLocalTime(dateString) {
    // Convert dateString to ISO 8601 format if necessary to avoid parsing issues
...
function formatLocalDateWithFallback(date) {
    if (isNaN(date.getTime())) {
        return 'Invalid Date'; // Return this if date is invalid
    }

    // First format: Aug-27 @ 15:30
    ...
    return formatted1 || formatted2 || formattedFallback;
}
